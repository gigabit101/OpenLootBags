 ...
 */
public class CommandInv implements IInventory
{
    private static final ItemStack[] FALLBACK_INVENTORY = new ItemStack[2];
    ...
    //TODO fix this (Currently just a copy of bag inv)
    public CommandInv(EntityPlayer player, int slot)
    {
        this.player = player;
        this.slot = slot;
    }
    ...
    public void pushInventory()
    {
        ...
        if(stack != null)
        {
            ...
            ItemLootBag.setStacks(stack, inv);
        }
        invPushed = true;
    }
    ...
    @Override
    public ItemStack getStackInSlot(int i) {return getInventory()[i];}
