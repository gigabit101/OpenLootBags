...
public class InvLootBag implements IInventory
{
    ...
    public InvLootBag(EntityPlayer player, int slot)
    {
        this.player = player;
        this.slot = slot;
    }
    ...
    {
        return stack != null && stack.getItem() == OpenLootBags.lootbag;
    }
    ...
    ItemStack[] getInventory()
    {
        ...
        if(isBag(getStack()))
        {
            stacks = ItemLootBag.loadStacks(stack);
            return stacks;
        }
    ...
    @Override
    public String getName() { return "lootbag"; }
